...
echo "============================================"
echo ""
echo "  API:          https://qtra-api.zayenha.app"
echo "  WebSocket:    https://qtra-ws.zayenha.app"
echo "  Grafana:      https://qtra-grafana.zayenha.app  (user: admin / pass: admin)"
echo "  Jaeger:       https://qtra-jaeger.zayenha.app"
echo "  Redis:        https://qtra-redis.zayenha.app"
echo "  pgAdmin:      https://qtra-pg.zayenha.app  (user: admin@zayenha.app / pass: admin)"
echo "  Dashboard:    https://qatra-k3s.zayenha.app"
echo ""
...
echo "    - qtra-api.zayenha.app"
echo "    - qtra-ws.zayenha.app"
echo "    - qtra-grafana.zayenha.app"
echo "    - qtra-jaeger.zayenha.app"
echo "    - qtra-redis.zayenha.app"
echo "    - qtra-pg.zayenha.app"
echo "    - qatra-k3s.zayenha.app"
echo ""
echo "  Check status:"
